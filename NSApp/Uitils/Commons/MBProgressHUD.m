...
- (void)layoutSubviews {
    ...
    indFrame.origin.x = floorf((frame.size.width - indFrame.size.width) / 2) + self.xOffset-70;
    indFrame.origin.y = floorf((frame.size.height - indFrame.size.height) / 2) + self.yOffset+15;
...
//        }
        ...
        CGRect lFrame = CGRectMake(floorf((frame.size.width - lWidth) / 2) + xOffset+30,
                                   floorf(indFrame.origin.y + indFrame.size.height + PADDING)-30,
                                   lWidth, lHeight);
        label.frame = lFrame;
